...
function initForms() {
  ...
  // As necessary icons are not available on Font-awesome
  // and to keep DOM clean they injected via jQuery
  var dollarSign = `
  ...
  // Logo image converted to base64 as regular
  // image file doesn't work on PDF conversion
  // So, it converted to base64 then dataUri and
  // Injected to DOM via jquery
...
//===============================================================
// Function to validate the form, if user don't fill up necessary
// fields then required field will be marked via css
//===============================================================
