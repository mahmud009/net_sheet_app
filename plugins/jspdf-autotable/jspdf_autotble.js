...
})(typeof this !== "undefined" ? this : window, function (
    ...
    /******/ [
        ...
        function parseSpacing(value, defaultValue) {
          ...
          if (typeof value === "object") {
            ...
            return {
              ...
              top:
                (_b = value.top) !== null && _b !== void 0 ? _b : defaultValue,
              right:
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function parseSettings(doc, options) {
          ...
          return {
            includeHiddenHtml:
              (_e = options.includeHiddenHtml) !== null && _e !== void 0
                ? _e
                : false,
            useCss: useCss,
            theme: theme,
            ...
            margin: margin,
            pageBreak:
              (_f = options.pageBreak) !== null && _f !== void 0 ? _f : "auto",
            rowPageBreak:
              (_g = options.rowPageBreak) !== null && _g !== void 0
                ? _g
                : "auto",
            tableWidth:
              (_h = options.tableWidth) !== null && _h !== void 0 ? _h : "auto",
            showHead: showHead,
            showFoot: showFoot,
            tableLineWidth:
              (_j = options.tableLineWidth) !== null && _j !== void 0 ? _j : 0,
            tableLineColor:
              (_k = options.tableLineColor) !== null && _k !== void 0
                ? _k
                : 200,
          };
        }
        ...
        function calculate(doc, table) {
          ...
          table.allRows().forEach(function (row) {
            for (var _i = 0, _a = table.columns; _i < _a.length; _i++) {
              ...
              cell.contentWidth =
                common_1.getStringWidth(cell.text, cell.styles, doc) + padding;
